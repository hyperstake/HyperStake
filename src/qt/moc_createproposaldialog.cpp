...
#include "qt/createproposaldialog.h"
...
QT_MOC_LITERAL(1, 21, 32), // "on_button_CreateProposal_clicked"
QT_MOC_LITERAL(2, 54, 0), // ""
QT_MOC_LITERAL(3, 55, 30) // "on_button_SendProposal_clicked"

    },
    "CreateProposalDialog\0"
    "on_button_CreateProposal_clicked\0\0"
    "on_button_SendProposal_clicked"
};
...
void CreateProposalDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CreateProposalDialog *_t = static_cast<CreateProposalDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_button_CreateProposal_clicked(); break;
        case 1: _t->on_button_SendProposal_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject CreateProposalDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CreateProposalDialog.data,
      qt_meta_data_CreateProposalDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CreateProposalDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CreateProposalDialog.stringdata0))
        return static_cast<void*>(const_cast< CreateProposalDialog*>(this));
